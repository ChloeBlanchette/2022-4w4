<?php  
/* 
    Ajout d'une fonction de personnalisation en utilisant la classe WP_Cu
...
add_action('customize_register', function(WP_Customize_Manager $manager) {
    ...
    $manager->add_setting('background_clipath',
                          [
                           "default"=>"#ffffff",
                           "sanitize_callback"=>"sanitize_hex_color"
                          ]);
    ...
    */
    ...
    $manager->add_control(new WP_Customize_Color_Control($manager, 'background_clipath',
                          [
                            "section"=>"apparence_body",
                            "label"=>"Choisir la couleur clip-path"
                          ]));
})
